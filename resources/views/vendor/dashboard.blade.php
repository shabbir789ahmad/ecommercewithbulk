									...
									<div class="col-sm-6">
										...
										<div class="card shadow bg-warning">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3 text-light">14.212</h1>
												<div class="mb-0">
													<span class="text-success"> <i class="mdi mdi-arrow-bottom-right text-light"></i> 5.25% </span>
									...
									<div class="col-sm-6">
										<div class="card shadow bg-danger">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title text-light">Earnings</h5>
													</div>
												...
												<h1 class="mt-1 mb-3 text-light">$21.300</h1>
												<div class="mb-0">
													<span class="text-success"> <i class="mdi mdi-arrow-bottom-right text-light"></i> 6.65% </span>
													<span class="text-light">Since last week</span>
												</div>
											</div>
										</div>
