	  ...
	  <div class="table-responsive ">
		<table id="example" class="table table-striped table-bordered mt-3" style="width:100%">
		 ...
		 <tr>
			...
			<td class="col-2">
				<a href="{{ route('orders.detail.vendor', ['id' => $order->id]) }}" class="btn btn-xs btn-info">Edit</a>
				<form action="{{ route('orders.delete.vendor', ['id' => $order->id]) }}" method="POST" class="d-inline" onsubmit="return confirmDelete()">
					@method('DELETE')
					@csrf
