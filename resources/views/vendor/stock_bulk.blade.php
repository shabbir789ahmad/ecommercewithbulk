...
<a href="{{url('vendor/get-product')}}" class="ml-auto">
...
<a href="{{url('vendor/get-product')}}">
 ...
 <div class="d-flex w-25 mt-3 ">
  <a href="{{url('vendor/add-stock')}}" class="ml-auto">
   <div class="card shadow border ml-auto text-light p-0 mr-2 btn-color @if(request()->is('vendor/add-stock')) act @else sing2 @endif">
    <div class="card-body text-light">
   <i class="fas fa-pencil-alt text-light fa-lg"></i> Single
   </div>
 </div>
</a> 
    <a href="{{url('vendor/add-stock-bulk')}}" class="ml-auto">
   <div class="card shadow border @if(request()->is('vendor/add-stock-bulk')) act @else act2 @endif ml-auto p-0 mr-2">
    <div class="card-body text-light">
...
<div class="card" id="bulk" >
 <div class="card-body">
   ...
   <form action="{{url('vendor/bulk-stock')}}" method="POST" enctype="multipart/form-data" class="mt-5">
  @csrf
