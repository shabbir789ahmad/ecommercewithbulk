...
<div class="container-fluid " >
 <div class="row ml-2 mr-2">
  ...
  <div class="col-md-3 col-12">
   <div class="card shadow" style="width: 100%; height:22rem">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="{{url('vendor/update-deal')}}" method="POST" enctype="multipart/form-data">
           ...
           <label class="mt-1 font-weight-bold">New Deal Detail</label>
           <textarea name="deal_detail" id="ddetail" class="form-control"></textarea>
