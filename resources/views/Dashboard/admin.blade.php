...
<li class="nav-item">
 ...
 <div id="collapseBootstrap13" class="collapse @if(request()->is('admin/stock-show')) show
         @elseif(request()->is('admin/add-stock'))
         show
         @endif" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
  <div class=" py-2 collapse-inner rounded">
    <a class="collapse-item" href="{{url('admin/stock-show')}}">All  Stock
    </a>
     <a class="collapse-item" href="{{url('admin/add-stock')}}">Upload  Stock
    </a>
