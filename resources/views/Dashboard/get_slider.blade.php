     ...
     <a href="{{url('admin/slider')}}">
      <div class="card shadow border p-0 ">
       <div class="card-body text-dark">
        <i class="fab fa-slideshare text-success fa-lg"></i> Slider
       </div>
      </div>
     </a>
     <div class="card shadow border ml-auto w-50 p-0 ">
      <div class="card-body text-dark">
       <h4 class="text-center font-weight-bold text-color">All Slider</h4>
      </div>
     </div>
       ...
       <div class="card">
         <div class="card-body">
          ...
          <div class="b d-flex justify-content-center mt-3">
           ...
           <button class="btn btn-lg btn-color text-light"> Update</button>
           </a>
           <a href="{{'delete-slider/'.$slid['id']}}">  
            <button class="btn btn-lg btn-danger ml-3" onclick="return confirm('Are you sure?')"> Delete</button>
           </a>
          </div>
         </div>
        </div>
