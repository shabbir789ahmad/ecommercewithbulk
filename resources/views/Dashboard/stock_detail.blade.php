 ...
 <div class="card-body">
  <div class="row">
   ...
   <h6 class="font-weight-bold mt-3">Add New Stock</h6> 
    <hr class="mt-2">
   <div class="forme ">
    <form class="mt-4" action="{{url('admin/upate-stock')}}" method="POST" enctype="multipart/form-data">
      @csrf
    ...
    <hr class="mt-2">
     ...
     @foreach($colors as $color)
      ...
      <i class="fas fa-circle fa-2x "
       ...
       <i class="fas fa-trash-alt text-danger border shadow p-2" 
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-3">
        ...
        <input type="hidden" id="brand_id" name="brand_id" value="{{$stock['id']}}">
        <button class="btn-color btn text-light float-right mt-5 btn-lg">Update</button>
         </form>
      </div>
    </div>
 ...
 <div class="input-group clockpicker" id="clockPicker1">
    ...
    <div class="input-group-append">
     <span class="input-group-text add" id="img"><i class="fas fa-store"></i></span>
        ...
        <input type="hidden"  name="size_id" value="{{$stock['id']}}">
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-3">
        ...
        <input type="hidden"  name="filter_id" value="{{$stock['id']}}">
...
<div class="modal fade" id="image-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-3">
        <form action="{{url('admin/update-image')}}" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" id="dis_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{url('admin/upate-discount')}}" method="POST">
          @csrf
...
<div class="modal fade" id="stock_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{url('admin/update-stock2')}}" method="POST">
          @csrf
