...
<button class="btn float-right text-light btn-color" id="genrate">Genrate</button>
</div>     
</div>
</div>


<div class="card" id="bulk" style="display: ;">
 <div class="card-body">
...
<input class="form-control mt-2 drp"  type="text" name="drop_id[]"  />
...
<span class="text-danger ">@error('supply_id') {{$message}} @enderror</span>
 ...
 @php $i=1; @endphp
  ...
  <div class="custom-file mt-2">
    <input type="file" name="rimage[]" class="form-control file" id="images" multiple="multiple" />
